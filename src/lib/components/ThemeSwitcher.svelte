<script lang="ts">
	...
	// prettier-ignore
	import { modeCurrent, setModeUserPrefers, setModeCurrent, setInitialClassState, getModeOsPrefers
	} from '$lib/theme';
	...
	export let bgLight: string = 'text-foreground';
	/** Provide classes to set the dark background color. */
	export let bgDark: string = 'text-foreground';
	/** Provide classes to set the light SVG fill color. */
	export let fillLight: string = 'text-foreground';
	/** Provide classes to set the dark SVG fill color. */
	export let fillDark: string = 'fill-white';
	...
	export let ring: string = 'ring-surface-500/30';
