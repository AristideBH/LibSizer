// from https://github.com/skeletonlabs/skeleton/blob/master/packages/skeleton/src/lib/utilities/LightSwitch/lightswitch.ts
// Lightswitch Service
...
export const modeOsPrefers = writable("modeOsPrefers", false)
/** Store: User Preference Mode */
export const modeUserPrefers = writable<boolean | undefined>("modeUserPrefers", undefined)
/** Store: Current Mode State */
export const modeCurrent = writable("modeCurrent", false)
